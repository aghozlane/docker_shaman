...
RUN R -e "install.packages(c('shiny', 'shinydashboard', 'shinythemes', 'shinyjs', 'Rcpp', 'rjson', 'devtools', 'psych', 'ggplot2', 'vegan', 'dendextend', 'circlize', 'googleVis', 'DT', 'RColorBrewer', 'ade4', 'scales', 'gplots'), repos='http://cran.rstudio.com/'); source('http://bioconductor.org/biocLite.R'); biocLite(c('BiocInstaller', 'genefilter', 'DESeq2')); options(download.file.method = 'wget'); devtools::install_github(c('aghozlane/biomformat', 'aghozlane/rNVD3', 'timelyportfolio/d3vennR', 'aghozlane/d3heatmap', 'aghozlane/scatterD3', 'pierreLec/treeWeightD3', 'aghozlane/shinydashboard'))"""
